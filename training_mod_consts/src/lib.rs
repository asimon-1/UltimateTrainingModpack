...
pub struct TrainingModpackMenu {
    ...
    pub save_slot_to_save: SaveStateSlot,
    pub save_slot_to_load: SaveStateSlot,
...
pub static DEFAULTS_MENU: TrainingModpackMenu = TrainingModpackMenu {
    ...
    save_slot_to_save: SaveStateSlot::S1,
    save_slot_to_load: SaveStateSlot::empty(),
...
impl_toggletrait! {
    ...
    "Enable Save States",
    "save_state_enable",
    "Save States: Enable or disable save states! Reset to a preconfigured scenario in-game.",
    true,
    1,
}
impl_toggletrait! {
    ...
    "Slot to Save",
    "save_slot_to_save",
    "Slot to Save: Which save state slot to create.",
    true,
    1,
}
impl_toggletrait! {
    ...
    "Slot to Load",
    "save_slot_to_load",
    "Slot to Load: Which save state slot(s) to load from.",
    false,
    TOGGLE_MAX,
}
impl_toggletrait! {
